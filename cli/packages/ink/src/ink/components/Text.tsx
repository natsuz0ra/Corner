...
const LEGACY_COLOR_ALIASES: Record<string, Color> = {
  black: 'ansi:black',
  red: 'ansi:red',
  green: 'ansi:green',
  yellow: 'ansi:yellow',
...
function normalizeColor(color: Color | undefined): Color | undefined {
  if (!color) {
    return undefined
  }
  if (/^\d+$/.test(color)) {
...
type BaseProps = {
  ...
  /**
   * Backwards-compatible alias used by upstream Ink.
   */
